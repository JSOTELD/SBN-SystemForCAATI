...
screens.indicators=async view=>{
  ...
  async function charts(){
    ...
    const studies=await request('/research/guides');const study=studies.find(s=>s.id===choice.value);if(!study)return;
